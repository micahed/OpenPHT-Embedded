...
post_makeinstall_target() {
  ...
  mkdir -p $INSTALL/usr/config/bluetooth
    cp -PR $PKG_BUILD/src/main.conf $INSTALL/usr/config/bluetooth
    sed -i $INSTALL/usr/config/bluetooth/main.conf \
        -e "s|^#\[Policy\]|\[Policy\]|g" \
        -e "s|^#AutoEnable.*|AutoEnable=true|g"
    cp -PR $PKG_BUILD/profiles/proximity/proximity.conf $INSTALL/usr/config/bluetooth
    cp -PR $PKG_BUILD/profiles/network/network.conf $INSTALL/usr/config/bluetooth
}
