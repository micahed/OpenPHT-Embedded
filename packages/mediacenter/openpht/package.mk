...
post_makeinstall_target() {
  ...
  mkdir -p $INSTALL/usr/lib/openpht
    ...
    cp $PKG_DIR/scripts/openpht-safe-mode $INSTALL/usr/lib/openpht
    ...
    $SED -e "s|@KODI_MAX_RESTARTS@|${KODI_MAX_RESTARTS:-5}|g" \
         ...
         -i $INSTALL/usr/lib/openpht/openpht.sh
  ...
  mkdir -p $INSTALL/usr/share/openpht/addons
    ...
    cp -R $PKG_DIR/config/repository.retroplayer.libreelec.tv $INSTALL/usr/share/openpht/addons
    $SED "s|@ADDON_URL@|http://lrusak.libreelec.tv/addons/$ADDON_PATH|g" $INSTALL/usr/share/openpht/addons/repository.retroplayer.libreelec.tv/addon.xml
  ...
  $PKG_DIR/scripts/xml_merge.py $PKG_DIR/config/guisettings.xml \
                                $PROJECT_DIR/$PROJECT/openpht/guisettings.xml \
                                $PROJECT_DIR/$PROJECT/devices/$DEVICE/openpht/guisettings.xml \
                                > $INSTALL/usr/share/openpht/config/guisettings.xml

  $PKG_DIR/scripts/xml_merge.py $PKG_DIR/config/sources.xml \
                                $PROJECT_DIR/$PROJECT/openpht/sources.xml \
                                $PROJECT_DIR/$PROJECT/devices/$DEVICE/openpht/sources.xml \
                                > $INSTALL/usr/share/openpht/config/sources.xml

  $PKG_DIR/scripts/xml_merge.py $PKG_DIR/config/advancedsettings.xml \
                                $PROJECT_DIR/$PROJECT/openpht/advancedsettings.xml \
                                $PROJECT_DIR/$PROJECT/devices/$DEVICE/openpht/advancedsettings.xml \
                                > $INSTALL/usr/share/openpht/system/advancedsettings.xml

  $PKG_DIR/scripts/xml_merge.py $PKG_DIR/config/appliance.xml \
                                $PROJECT_DIR/$PROJECT/openpht/appliance.xml \
                                $PROJECT_DIR/$PROJECT/devices/$DEVICE/openpht/appliance.xml \
                                > $INSTALL/usr/share/openpht/system/settings/appliance.xml
